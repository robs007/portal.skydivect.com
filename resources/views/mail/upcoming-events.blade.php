                ...
                <a href="#" class="block hover:bg-gray-50">
                    <div class="px-4 py-4 sm:px-6">
                        <div class="flex items-center justify-between">
                            <p class="truncate text-sm font-medium text-indigo-600">Club Meeting</p>
                            <div class="ml-2 flex flex-shrink-0 hidden">
                                <a href="#" class=" hidden inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">Register</a>
                            </div>
                        </div>
                        <div class="mt-2 sm:flex sm:justify-between">
                            <div class="sm:flex">
                                ...
                                <p class=" hidden mt-2 flex items-center text-sm text-gray-500 sm:mt-0 sm:ml-6">
...
{{--            </li>--}}
        ...
        <ul>
            <li>Club Meeting 5/21/22 6: 00p </li>
            <li>Canopy Coure 5/322 8 :00 <a href="#">registe</a> </li>
        </ul>
    </div>
