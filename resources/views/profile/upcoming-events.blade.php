{{--<x-base>--}}
{{--    <h2>Upcoming CPI Events</h2>--}}
{{--    <div class="overflow-hidden bg-white shadow sm:rounded-md">--}}

{{--        <ul>--}}
{{--            @foreach($events as $event)--}}
{{--                <li class="px-3">{{$event->start_date}} {{$event->title}} {{$event->start_time}} {{$event->has_registration}}    @if($event->has_registration === 1)--}}
{{--                        <a href="https://skydivect.com/register?id={{$event->id}}">Register</a>--}}
{{--                    @endif--}}
{{--                </li>--}}
{{--            @endforeach--}}
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,700,400italic,700italic" rel="stylesheet" type="text/css"><!--<![endif]--><style type="text/css">
        .main,.mso{background-color:#1e1e1e}.logo a:hover,.logo a:focus{color:#fff !important}.footer-logo a:hover,.footer-logo a:focus{color:#b59b69 !important}.mso .layout-has-border{border-top:1px solid #000;border-bottom:1px solid #000}.mso .layout-has-bottom-border{border-bottom:1px solid #000}.mso .border,.ie .border{background-color:#000}.mso h1,.ie h1{}.mso h1,.ie h1{font-size:30px !important;line-height:38px !important}.mso h2,.ie h2{}.mso h2,.ie h2{font-size:20px !important;line-height:28px !important}.mso h3,.ie h3{}.mso .layout__inner,.ie .layout__inner{}.mso .footer__share-button p{}.mso .footer__share-button p{font-family:Avenir,sans-serif}
    </style><meta name="robots" content="noindex,nofollow">
    <meta property="og:title" content="">
    <link href="https://css.createsend1.com/frontend/css/previewiframe.090e57e0c6577c59a7cf.min.css?c=1587855496" rel="stylesheet"></head>
<!--[if mso]>
<body class="mso">
<![endif]-->
<!--[if !mso]><!-->
<body class="main half-padding" style="margin: 0px; padding: 0px; text-size-adjust: 100%; height: 564px; overflow-y: hidden;">
<!--<![endif]-->
<table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #1e1e1e;" cellpadding="0" cellspacing="0" role="presentation">
    <tbody>
    <tr>
        <td>
            <div role="banner">
                <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 167440px);">
                    <div style="border-collapse: collapse;display: table;width: 100%;">
                        ...
                        <div class="snippet" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #e8e8e8;font-family: Avenir,sans-serif;">

                        </div>
                        <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
                        <div class="webversion" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #e8e8e8;font-family: Avenir,sans-serif;">
            ...
            <div>
                <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #212a32;">
                        ...
                        <div class="column" style="text-align: left;color: #fff;font-size: 16px;line-height: 24px;font-family: Roboto,Tahoma,sans-serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #707f8f;font-size: 16px;line-height: 24px;text-align: center;">Save the date for our upcoming events</h3>
                                    <h1 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #d49344;font-size: 26px;line-height: 34px;text-align: center;">CPI Events</h1>
                                    ...
                                    <ul style="Margin-top: 20px;Margin-bottom: 20px;Margin-left: 24px;padding: 0;list-style-type: disc;">
                                        @foreach($events as $event)
                                            <li style="Margin-top: 20px;Margin-bottom: 0;Margin-left: 0;">{{$event->start_date}} {{$event->title}} {{$event->start_time}}
                                                @unless(!$event->has_registration)
                                                <a href="https://skydivect.com/experienced-jumpers/event-registration?id={{$event->id}}">Register</a>
                                                @endunless
                                            </li>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                                    <!--[if !mso]><!--><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #4c5b6b;font-family: Roboto, Tahoma, sans-serif;" href="https://skydivect.com/experienced-jumpers/events-calendar" target="_blank">Event Calendar</a><!--<![endif]-->
                                    <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="https://skydivect.com/experienced-jumpers/events-calendar" style="width:94.5pt" arcsize="9%" fillcolor="#4C5B6B" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0pt,8.25pt,0pt,8.25pt"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Roboto,Tahoma,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:1.5px">Event Calendar</center></v:textbox></v:roundrect><![endif]-->
                                </div>
                            </div>
